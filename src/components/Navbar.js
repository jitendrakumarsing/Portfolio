...
list.style.display = list.style.display !== 'grid' ? 'grid' : 'none';
  ...
  return (
   ...
   <nav className="navbar">
    ...
    <li><a className="link" href="/#Home" onClick={handleclick}  >Home</a></li>
    <li><a  className="link" href="#Work" onClick={handleclick}>Work</a></li>
    <li><a className="link" href="#Education" onClick={handleclick}>Education</a></li>
    <li><a className="link" href="#About" onClick={handleclick}>About</a></li>
    </ul>
