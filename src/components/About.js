...
<>
    <div className="about-page">
      ...
      <div className='innerbody' >
        ...
        <p>I am jitendra kumar bachelor in mechanical engineering, Formarly i worked as a mechanical engineer in a reputed manufacturing company.
          In my last career i successfully completed my all duties starting from trainee engineer to production supervisor and last junier production engineer.,<br/>
          ...
          where i can learn and work for organisation. I believe in myself i will give my best and always try to give best.
        </p>
      </div>
      </div>
      </div>
